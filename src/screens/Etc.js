    ...
    return (
        <ScrollView style={styles.container}>
            <View style={styles.case1}>
                <TopNavigation2 name='etc'/>
                <View style={[styles.elem, {backgroundColor:'#F5F6FA'}]}>
                    <View style={{flexDirection:'row', alignItems:'center'}}>
                        <Image source={require('../../assets/etc4.png')} style={{width:28, height:30}} />
                        <Text  style={{fontFamily:'NotoSansKR-Bold', fontSize:20, marginLeft:5}}>기타</Text>
                    </View>
