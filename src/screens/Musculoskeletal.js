    ...
    return (
        <ScrollView style={styles.container}>
            <View style={styles.case1}>
                <TopNavigation2 name='musculoskeletal'/>
                <View style={[styles.elem, {backgroundColor:'#F5F6FA'}]}>
                    <View style={{flexDirection:'row', alignItems:'center'}}>
                        <Image source={require('../../assets/musculoskeletal.png')} style={{width:30, height:35}} />
                        <Text  style={{fontFamily:'NotoSansKR-Bold', fontSize:20, marginLeft:10}}>근골격</Text>
                    </View>
